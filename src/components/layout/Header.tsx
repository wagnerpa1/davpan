    ...
    <header className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white shadow-sm">
      <div className="container mx-auto flex h-16 items-center px-4">
        ...
        <nav className="ml-8 hidden md:flex items-center space-x-6">
          ...
          {canManage && (
            <Link
              ...
              className="text-sm font-bold text-jdav-green hover:text-jdav-green-dark transition-colors"
            >
              Guide-Bereich
            </Link>
          )}
        ...
        <div className="ml-auto flex items-center space-x-4">
          <Link
            href="/profile"
            className="hidden md:block text-sm font-medium text-slate-600 hover:text-jdav-green transition-colors"
          >
            Profil
          </Link>
          <form
